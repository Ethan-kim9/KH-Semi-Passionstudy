...
/* 1/9일 FAQ_BOARD 테이블 카테고리 추가 & 이름 변경*/
ALTER TABLE FAQ_BOARD ADD CATEGORY VARCHAR2(200);
ALTER TABLE FAQ_BOARD RENAME COLUMN CATEGORY TO FAQ_CATEGORY;
COMMIT;

/* 1/10일 FAQ_BOARD 테이블 페이징처리 추가*/
ALTER TABLE FAQ_BOARD ADD PAGING_STACK NUMBER;
commit;

/*RESERVATION테이블 데이터 변경*/
ALTER TABLE RESERVATION MODIFY RESERVATION_MONITOR number;
ALTER TABLE RESERVATION MODIFY PAYMENT_DATE DATE NULL;
ALTER TABLE RESERVATION ADD RESERVATION_MSG VARCHAR2(2000);
commit;