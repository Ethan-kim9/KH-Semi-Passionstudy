    ...
    <section class="mypage-section">
            ...
            <div class="mypage-withdrawal2">
              <div class="withdrawal-fin-front">
                ...
                <h6 class="withdrawal-fin-front_g1">회원탈퇴가 안전하게 완료되었습니다.</h6>
                <h6 class="withdrawal-fin-front_g2">보다 나은 서비스로 다시 찾아 뵙겠습니다.</h6>
              </div>
              <button class="withdrawal-fin-button"><a href="/passion">열정카페 첫 화면</a></button>
            </div>
