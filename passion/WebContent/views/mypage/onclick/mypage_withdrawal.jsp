        ...
        <div class="container_mypage-management">
          <ul>
            <li class="mypage-single-menu">
              <a href="<%=contextPath %>/MyInfoEditProc"><button class="first-teb-button on">돌아가기</button></a>
            </li>
          </ul>
        </div>
        <!-- 회원탈퇴 전 -->
        <form class="withdrawal_wrap" action="<%=contextPath %>/goodbye" method="post">
          <div class="withdrawal-mold">
            <div class="mypage-withdrawal1">
              <div class="withdrawal-front">
                ...
                <h6 class="withdrawal-front_g1">회원탈퇴를 하시려면 안내 및 동의가 필요합니다.</h6>
                <h6 class="withdrawal-front_g2">정말로 회원탈퇴를 진행하시겠습니까?</h6>
              </div>
