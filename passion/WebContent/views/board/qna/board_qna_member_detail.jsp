      ...
      <div id="board">
        <div id="board_main">
            <div id="another_buttons">
                ...
                <input type="button" value="답변달기" class="write_btn yb" style="float: none" OnClick="window.location='index.jsp?inc=./views/board/qna/board_qna_manager_write.jsp?idx=<%=idx %>'">
              </div>
